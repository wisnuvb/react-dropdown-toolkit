...
describe('Dropdown Component', () => {
  ...
  test('toggles dropdown visibility on click and handles search term', () => {
    render(<Dropdown options={options} withSearch={true} multiple={false} portal={false} />);
  ...
  test('closes dropdown when clicking outside of it', () => {
    render(<Dropdown options={options} withSearch={false} multiple={false} portal={false} />);
  ...
  test('should render custom options when customRenderOption is provided', () => {
    render(<Dropdown options={options} customRenderOption={customRenderOption} />);
